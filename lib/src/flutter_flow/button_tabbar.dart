...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _WgButtonTabBarState tabBar;
...
class WgButtonTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [WgButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<WgButtonTabBar> createState() => _WgButtonTabBarState();
}

class _WgButtonTabBarState extends State<WgButtonTabBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(WgButtonTabBar oldWidget) {
