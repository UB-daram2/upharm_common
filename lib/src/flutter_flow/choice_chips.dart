...
class WgChoiceChips extends StatefulWidget {
  const WgChoiceChips({
    super.key,
  ...
  final WidgetController<List<String>> controller;
  ...
  @override
  State<WgChoiceChips> createState() => _WgChoiceChipsState();
}

class _WgChoiceChipsState extends State<WgChoiceChips> {
