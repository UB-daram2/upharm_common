...
class WgDropDown<T> extends StatefulWidget {
  const WgDropDown({
    super.key,
    this.controller,
  ...
  final WidgetController<List<T>?>? multiSelectController;
  ...
  @override
  State<WgDropDown<T>> createState() => _WgDropDownState<T>();
}

class _WgDropDownState<T> extends State<WgDropDown<T>> {
  bool get isMultiSelect => widget.isMultiSelect;
  WidgetController<T?> get controller => widget.controller!;
  WidgetController<List<T>?> get multiSelectController => widget.multiSelectController!;
