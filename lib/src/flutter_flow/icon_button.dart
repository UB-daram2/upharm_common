...
class WgIconButton extends StatefulWidget {
  const WgIconButton({
    super.key,
    required this.icon,
    this.borderColor,
  ...
  @override
  State<WgIconButton> createState() => _WgIconButtonState();
}

class _WgIconButtonState extends State<WgIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(WgIconButton oldWidget) {
