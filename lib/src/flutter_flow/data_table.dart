...
class WgDataTableController<T> extends DataTableSource {
  WgDataTableController({
    List<T>? initialData,
    int? numRows,
...
class WgDataTable<T> extends StatefulWidget {
  const WgDataTable({
    super.key,
  ...
  final WgDataTableController<T> controller;
  final List<T> data;
  final int? numRows;
  ...
  @override
  State<WgDataTable<T>> createState() => _WgDataTableState<T>();
}

class _WgDataTableState<T> extends State<WgDataTable<T>> {
  WgDataTableController<T> get controller => widget.controller;
  ...
  @override
  void didUpdateWidget(WgDataTable<T> oldWidget) {
    ...
    final checkboxThemeData = CheckboxThemeData(
      ...
      fillColor: MaterialStateProperty.resolveWith(
        (states) => states.contains(MaterialState.selected)
            ...
            : widget.checkboxUnselectedFillColor ?? Colors.white.withOpacity(0.01),
      ),
      ...
      child: SizedBox(
        ...
        child: Theme(
          ...
          child: PaginatedDataTable2(
            ...
            rowsPerPage: widget.paginated || rowCount == 0 ? initialRowsPerPage : rowCount,
