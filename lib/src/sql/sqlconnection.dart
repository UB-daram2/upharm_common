...
class SqlConnection {
  ...
  dynamic _parseResult(String json) {
    ...
    if (result["type"] == "ok") {
      ...
      return _TableResult(result["tablename"], result["rows"], result["columns"]);
...
class _TableResult {
  ...
  _TableResult(String tableName, List<Map<String, dynamic>> rows, List<Map<String, String>> columns) {
